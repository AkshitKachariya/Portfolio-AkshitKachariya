...
const projectsData = [
    {
        id: '2',
        title: 'StudXWork',
        subtitle: 'Student Hustle Hub',
        image: 'studxwork-cover-image.jpg',
        github: 'https://github.com/AkshitKachariya/Project---StudXWork-Student-Hustle-Hub',
        tech: ['React.js', 'Tailwind CSS', 'Node.js', 'Express.js', 'MongoDB'],
        overview: 'StudXWork - Student Hustle Hub is a full-stack platform designed to connect students and recruiters in a single ecosystem. The platform enables students to discover job opportunities, apply for tasks, access study materials, communicate with recruiters, and manage their activities through an intuitive and responsive interface. Recruiters can post jobs and tasks, manage applications, and connect with potential candidates, while administrators oversee platform operations, user management, support requests, notices, and overall system functionality.',
        challenge: 'The main challenge was developing a scalable multi-role platform with secure authentication, job/task management, messaging, wallet functionality, and role-based access control while maintaining a responsive and user-friendly experience across all modules.',
        solution: 'The project was developed using React.js, Tailwind CSS, Node.js, Express.js, and MongoDB. The platform connects students and recruiters through job postings, task management, study resources, messaging, wallet management, and application tracking, supported by dedicated Student, Recruiter, and Admin Panels.',
        stats: [
            { stat: '3', label: 'Roles' },
            { stat: 'Real-time', label: 'Chat' },
            { stat: 'Secure', label: 'Auth' }
        ],
        results: [
            'Responsive and user-friendly Student Hustle Hub platform',
            'Secure login & role-based authentication system',
            'Efficient job, task, and application management',
            'Integrated real-time messaging and communication',
            'Wallet, request, and support management features',
            'Modern UI/UX with cross-device compatibility'
        ]
    },
    {
        id: '1',
        title: 'Asopalav',
        subtitle: 'The Cloth Store',
        image: 'asopalav-cover-image.jpg',
        github: 'https://github.com/AkshitKachariya/DummyProject---Asopalav---The-Cloth-Store',
        tech: ['HTML5', 'CSS3', 'Tailwind', 'JavaScript', 'Core PHP', 'MySQL'],
        overview: 'Asopalav - The Cloth Store is a dummy E-commerce website developed for men’s and women’s fashion shopping. The platform allows users to browse clothing categories, view product details, manage carts, and place orders through a responsive and user-friendly interface.',
        challenge: 'The main challenge was building a complete eCommerce system with both Admin Panel and User Panel while maintaining responsive design, smooth navigation, secure authentication, and proper product/order management.',
        solution: 'The project was developed using HTML, CSS, Tailwind CSS, JavaScript, Core PHP, and MySQL. The system includes an Admin Panel for managing products, categories, users, orders, store locations, and branding.',
        stats: [
        ...
        results: [
            'Responsive online clothing store',
            'Secure login & authentication system',
            'Organized category & product management',
            'Efficient order handling & UI/UX design'
        ]
    }
];

const ProjectCard = ({ project, isMobile, isSmallDesktop, imageWidth, containerHeight }) => {
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', marginBottom: '1rem' }}>
                        <div>
                            <h3 style={{
                                ...
                                <span style={{ fontFamily: 'JetBrains Mono', color: '#fbbf24', fontSize: '1.2rem', fontWeight: 400 }}>{project.id}.</span> {project.title}
                            </h3>
                            <p style={{
